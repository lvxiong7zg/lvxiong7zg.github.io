...
layout : post
title : PDF简历信息提取
date : '2020-03-05 10:05:00 +0800'
categories: Python
---

>原文地址：http://www.yooongchun.cn/2019/08/13/pdf-resume-extractor/

>基本思路：pdfplumber包提取PDF文件的文本内容————通过正则表达式查找匹配值
...
````YMAL 
##http://www.yooongchun.cn/2019/08/13/pdf-resume-extractor/
...
if __name__ == "__main__":
    FILE_DIR = r"C:\Users\Administrator\Desktop\1"  #待提取文件地址
    OUT_DIR = r"resume-data.xlsx"  #保存地址
    args = sys.argv
