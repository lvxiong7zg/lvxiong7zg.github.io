...
def create_blog_list():
    ...
    global blog_list
    global total_blog
    pr = r'href="http://lvxiong7zg.com/(\d+)'
    rr = re.compile(pr)
    my_blog = []
    # my_blog = ['http://lvxiong7zg.com/page1', 'http://www.cnblogs.com/zpfbuaa/p/page2',
    #           'http://lvxiong7zg.com/page3']
    for i in range(2,3):
        blogitem = "http://lvxiong7zg.com/page" + str(i)
    ...
    for item in my_blog:
        ...
        req.add_header("User-Agent", "Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.186 Mobile Safari/537.36")
    ...
    for blog_key in list1:
        ...
        url = 'http://lvxiong7zg.com/' + blog_key + ".html"
