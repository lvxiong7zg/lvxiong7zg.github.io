---
layout : post
title : Python抢12306火车票（github）
data : '2019-09-11 22:05:00 +0800'
categories: Python
---
 >自动验码/自动登录/准点预售和捡漏/智能候补/邮件通知/微信通知
...
RE_VERSION = "1.1.110"
````
github项目地址: [testerSunshine/12306](https://github.com/testerSunshine/12306)
本机运行库：[uz7s](https://pan.baidu.com/s/1wSvXECiVYOXVjMe6KnJdYA)
